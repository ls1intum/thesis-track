...
export interface IHeroDotsProps extends ComponentPropsWithoutRef<'svg'> {
  size?: number
  radius?: number
}

export function HeroDots(props: IHeroDotsProps) {
  const { size = 185, radius = 2.5, ...others } = props
